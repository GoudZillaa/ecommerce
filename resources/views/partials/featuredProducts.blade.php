<?php
/**
 * Blade partial for the featured products section.
 * This file is intended to be included in a main view.
 * It contains the HTML structure for a product slider using Swiper.js.
 * Note: This code assumes that the necessary CSS and JavaScript files for Swiper.js
 * and other styles (like Bootstrap icons) have been properly linked in the main layout.
 */
?>
    ...
    <div class="container">
        ...
        <div class="discount-main p-relative">
            <div class="discount-slider-navigation furniture__navigation">
                <button type="button" class="discount-slider-button-prev" tabindex="0" aria-label="Next slide">
                    <i class="fa-regular fa-angle-left"></i>
                </button>
                <button type="button" class="discount-slider-button-next" tabindex="0" aria-label="Previous slide">
                    <i class="fa-regular fa-angle-right"></i>
                </button>
            </div>
            <div class="row align-items-center">
                <div class="col-xxl-12">
                    <div class="swiper furuniture-active swiper-initialized swiper-horizontal swiper-pointer-events">
                        <div class="swiper-wrapper">
                            {{-- The following is a single product slide. You will likely want to loop through an array of products here. --}}
                            <div class="swiper-slide">
                                <div class="product-item furniture__product">
                                    ...
                                    <div class="product-thumb theme-bg-2">
                                        {{-- The image source should be dynamically linked to the public directory --}}
                                        <a href="{{ url('product-details.html') }}">
                                            <img src="{{ asset('assets/imgs/furniture/product/product1.png') }}" alt="">
                                        </a>
                                    ...
                                    <div class="product-content">
                                        {{-- The product title and price should be dynamic --}}
                                        <h4 class="product-title"><a href="{{ url('product-details.html') }}">Alexander roll
                                                Arm sofa</a></h4>
                            ...
                            <div class="swiper-slide">
                                <div class="product-item furniture__product">
                                    <div class="product-thumb theme-bg-2">
                                        <a href="{{ url('product-details.html') }}">
                                            <img src="{{ asset('assets/imgs/furniture/product/product2.png') }}" alt="">
                                        </a>
                                        <div class="product-action-item">
                                            <button type="button" class="product-action-btn">
                                                <svg width="20" height="22" viewBox="0 0 20 22" fill="none"
                                    ...
                                    <div class="product-content">
                                        <h4 class="product-title"><a href="{{ url('product-details.html') }}">Chair
                                                pillow</a></h4>
                                        <div class="user-rating">
                                            <i class="fal fa-star"></i>
                                            <i class="fal fa-star"></i>
