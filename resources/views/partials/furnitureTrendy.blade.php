   ...
   <div class="container">
      <div class="furniture-trendy__header">
         ...
         <div class="bd-product__filter-style furniture-trendy__tab nav nav-tabs" role="tablist">
            <button class="nav-link active" id="collection-tab" data-bs-toggle="tab" data-bs-target="#collection" type="button" role="tab" aria-selected="true">All Collection</button>
            <button class="nav-link" id="new-tab" data-bs-toggle="tab" data-bs-target="#new" type="button" role="tab" aria-selected="false" tabindex="-1">New In</button>
            <button class="nav-link" id="top-tab" data-bs-toggle="tab" data-bs-target="#top" type="button" role="tab" aria-selected="false" tabindex="-1">Top Rated</button>
            <button class="nav-link" id="tensing-tab" data-bs-toggle="tab" data-bs-target="#tensing" type="button" role="tab" aria-selected="false" tabindex="-1">Tensing Items</button>
         </div>
      </div>
            ...
            <div class="tab-pane fade active show" id="collection" role="tabpanel" aria-labelledby="collection-tab">
               <div class="row g-4">
                  <div class="col-xxl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                     <div class="product-item furniture__product">
                        ...
                        <div class="product-thumb theme-bg-2">
                           <a href="{{ url('#') }}"><img src="{{ asset('assets/imgs/furniture/product/product1.png') }}" alt=""></a>
                        ...
                        <div class="product-content">
                           <h4 class="product-title"><a href="{{ url('#') }}">stylish grey chair</a></h4>
                  ...
                  <div class="col-xxl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                     <div class="product-item furniture__product">
                        <div class="product-thumb theme-bg-2">
                           <a href="{{ url('#') }}"><img src="{{ asset('assets/imgs/furniture/product/product2.png') }}" alt=""></a>
                           <div class="product-action-item">
                              <button type="button" class="product-action-btn">
                                 <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M13.0768 10.1416C13.0768 11.9228 11.648 13.3666 9.88542 13.3666C8.1228 13.3666 6.69401 11.9228 6.69401 10.1416M1.375 5.84163H18.3958M1.375 5.84163V12.2916C1.375 19.1359 2.57494 20.3541 9.88542 20.3541C17.1959 20.3541 18.3958 19.1359 18.3958 12.2916V5.84163M1.375 5.84163L2.91454 2.73011C3.27495 2.00173 4.01165 1.54163 4.81754 1.54163H14.9533C15.7592 1.54163 16.4959 2.00173 16.8563 2.73011L18.3958 5.84163" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                        ...
                        <div class="product-content">
                           <h4 class="product-title"><a href="{{ url('#') }}">realistic sofa</a></h4>
                           <div class="user-rating mb-1">
                              <i class="far fa-star"></i>
                              <i class="far fa-star"></i>
                              <i class="far fa-star"></i>
                           ...
                           <div class="product-price">
                              <span class="product-new-price">USD 450.00</span>
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-xxl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                     <div class="product-item furniture__product">
                        ...
                        <div class="product-thumb theme-bg-2">
                           <a href="{{ url('#') }}"><img src="{{ asset('assets/imgs/furniture/product/product4.png') }}" alt=""></a>
                           <div class="product-action-item">
                              <button type="button" class="product-action-btn">
                                 <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M13.0768 10.1416C13.0768 11.9228 11.648 13.3666 9.88542 13.3666C8.1228 13.3666 6.69401 11.9228 6.69401 10.1416M1.375 5.84163H18.3958M1.375 5.84163V12.2916C1.375 19.1359 2.57494 20.3541 9.88542 20.3541C17.1959 20.3541 18.3958 19.1359 18.3958 12.2916V5.84163M1.375 5.84163L2.91454 2.73011C3.27495 2.00173 4.01165 1.54163 4.81754 1.54163H14.9533C15.7592 1.54163 16.4959 2.00173 16.8563 2.73011L18.3958 5.84163" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
