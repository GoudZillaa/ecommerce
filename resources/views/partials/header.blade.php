                ...
                <div class="header-to-main d-none d-sm-flex">
                    ...
                    <div class="tp-header-top-menu d-flex align-items-center justify-content-end">
                        <div class="header-lang-item header-lang">
                            ...
                            <ul>
                                <li><a class="furniture-clr-hover" href="#">Spanish</a></li>
                                <li><a class="furniture-clr-hover" href="#">Russian</a></li>
                                <li><a class="furniture-clr-hover" href="#">Portuguese</a></li>
                            </ul>
                        </div>
                        <div class="header-lang-item tp-header-currency">
                            ...
                            <ul>
                                <li><a class="furniture-clr-hover" href="#">EUR</a></li>
                                <li><a class="furniture-clr-hover" href="#">CHF</a></li>
                                <li><a class="furniture-clr-hover" href="#">GBP</a></li>
                                <li><a class="furniture-clr-hover" href="#">KWD</a></li>
                            </ul>
                        </div>
                        <div class="header-lang-item tp-header-setting">
                            ...
                            <ul>
                                <li><a class="furniture-clr-hover" href="#">My Profile</a></li>
                                <li><a class="furniture-clr-hover" href="{{ url('wishlist') }}">Wishlist</a></li>
                                <li><a class="furniture-clr-hover" href="{{ url('cart') }}">Cart</a></li>
                                <li><a class="furniture-clr-hover" href="#">Logout</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                    ...
                                    <nav id="mobile-menu" style="display: block;">
                                        <ul>
                                            <li class="has-dropdown">
                                                <a href="{{ url('/') }}">Home</a>
                                                <ul class="submenu">
                                                    <li><a href="{{ url('pharmacy') }}">Pharmacy Store</a></li>
                                                    <li><a href="{{ url('/') }}">Furniture Store</a></li>
                                                    <li><a href="{{ url('grocery') }}">Grocery Store</a></li>
                                                </ul>
                                            </li>
                                            ...
                                            <li class="has-dropdown">
                                                ...
                                                <ul class="submenu">
                                                    ...
                                                    <li><a href="{{ url('store') }}">Find a Store</a></li>
